...
<body>
    ...
    <script>
        ...
        button.classList.remove('boton-item'); // Quita la clase que define el estilo negro
        button.classList.add('boton-agregado'); // Agrega la clase que define el nuevo estilo
        }
    </script>
    </div>
</body>
