...
insert  into `usuario`(`idUsuario`,`tipoDocumentoUsuario`,`documentoUsuario`,`nombresUsuario`,`apellidosUsuario`,`correo`,`claveUsuario`,`estadoUsuario`,`rol_idRol`) values (1,'TI',99752136,'Juan    ','Pérez    ','juanperez@gmail.com','juan369','Activo',2),(2,'CC',987654321,'María   ','López    ','maria.lopez@example.com','maria5678','Inactivo',2),(3,'CE',12345678,'Carlos  ','Gómez    ','carlos.gomez@example.com','carlos9823','Activo',2),(4,'CC',789123456,'Pedro   ','Ramírez  ','pedroramirez@example.com','pedro5309','Inactivo',1),(5,'CC',321654987,'Ana     ','Rodríguez| ','Rodríguez@example.com','ana2716','Activo',2),(6,'CE',87654321,'Andrés  ','Silva    ','Silva@example.com','andres4992','Inactivo',2),(7,'CC',654987321,'Carolina','Vargas','carolina.vargas@example.com','carolina7248','Activo',2),(8,'CC',234567891,'Daniel  ','Martínez ','daniel.martinez@example.com','daniel2083','Inactivo',2),(9,'CC',987654321,'José    ','Castro   ','jose.castro@example.com','jose7529','Inactivo',2),(10,'CC',456789123,'Alejandro','Gómez','alejandrogomez@example.com','alejandro6165','Activo',1),(11,'CC',789123456,'Andrea','Herrera','andreaherrera@example.com','andreaherrera','Activo',2),(12,'CC',321654987,'Andrés  ','González ','Gonzalez@example.com','andres9614','Inactivo',2),(13,'CC',1000320746,'Daniel Mauricio','Flores Rueda','daniflores5492@gmail.com','daniel','Activo',1),(14,'CC',27867867,'carolina','rueda','adrianiyarueda@gmail.com','1234','Activo',2),(20,'CC',3543645,'armando','pizos','casas23@gmail.com','23','Activo',0),(22,'CC',342435345,'timmy','torner','padrinos@gmail.com','cosmo','Activo',0);
