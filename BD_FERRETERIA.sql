...
insert  into `ventas`(`idcodigo`,`producto`,`precio_unitario`,`cantidad`,`descripcion`,`Categoria`,`imagen`) values ('001','llaves respuesto',50000,10,'llaves','6','data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQ');
