...
CREATE TABLE `usuario` (
  ...
  `documentoUsuariorio` enum('CC','TI','CE') NOT NULL DEFAULT 'CC',
...
insert  into `ventas`(`idcodigo`,`producto`,`precio_unitario`,`cantidad`,`descripcion`,`Categoria`,`imagen`) values ('001','llaves respuesto',40000,10,'llaves','6','data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQ');
